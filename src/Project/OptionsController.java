...
public class OptionsController implements Initializable{
    ...
    public void addMembershipButton() throws IOException {
    ...
    public void loyaltyButtonClicked() throws IOException {
        Stage stage = (Stage) loyaltyButton.getScene().getWindow();
        stage.close();
        Parent root = FXMLLoader.load(getClass().getResource("SE_searchLoyalty.fxml"));
        Stage primaryStage = new Stage();
        primaryStage.setTitle("search loyalty catalogue");
        primaryStage.setScene(new Scene(root, 346.0, 621.0));
        primaryStage.show();
    }
