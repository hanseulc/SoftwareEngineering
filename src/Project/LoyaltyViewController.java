...
public class LoyaltyViewController implements Initializable {

    @FXML
    private Text loyaltyName;
    @FXML
    private Text points;
    @FXML
    ...
    public void simulateButtonClicked() {
        LibController.chosenLoyaltyScheme.addPoints();
        points.setText(LibController.chosenLoyaltyScheme.getPoints() + "");
    }


    @Override
    public void initialize(URL location, ResourceBundle resources) {
        loyaltyName.setText(LibController.chosenLoyaltyScheme.getName());
        points.setText(LibController.chosenLoyaltyScheme.getPoints() + "");
